...
public class RevertServer extends Thread {
	...
	public RevertServer() throws IOException {
		...
		//LagListener lagListener = new LagListener(30, 300, serverListener);
	...
	public void run(){
		...
		while(true){
			...
			try { Thread.sleep( (long) ((lastUpdateTime - System.nanoTime() + OPTIMAL_TIME) / 1000000) );}catch(Exception ex){};
