...
public class MainMenu {
	...
	public MainMenu(final Revert game){
		...
		atlas = new TextureAtlas(Gdx.files.internal("data/skins/gui-assets.txt"));
		
		playButtonSkin = new Skin(Gdx.files.internal("data/skins/button-play.json"), atlas);
		quitButtonSkin = new Skin(Gdx.files.internal("data/skins/button-quit.json"), atlas);
